...
@Component({
  ...
  imports: [ CommonModule,MatCardModule , MatFormFieldModule, MatInputModule, MatButtonModule,HeaderComponent],
...
// Remove redundant filterResults method and keep only:
ngOnInit() {
...
// [ng style] is used to apply inline styles
getRoleStyle(role: string): object {
  switch (role.toLowerCase()) {
    ...
    case 'moderator':
      return { 'background-color': '#ff9800', 'color': 'white' }; // Yellow
    default:
      return { 'background-color': '#9e9e9e', 'color': 'white' }; // Gray (default)
  }
}
